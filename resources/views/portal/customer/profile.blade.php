<x-layouts.app>
    <div class="max-w-3xl mx-auto">
        <div class="mb-6">
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Kelola informasi pribadi Anda</p>
        </div>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="email" value="{{ auth()->user()->email }}" disabled 
                               class="w-full px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-100 dark:bg-gray-800">
