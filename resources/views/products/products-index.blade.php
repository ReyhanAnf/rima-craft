<x-layouts.app>
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-5">
        <div>
            <h2 class="text-xl font-bold tracking-tight text-gray-900 dark:text-white">Katalog Produk</h2>
        ...
        <div class="flex w-full md:w-auto gap-3">
            ...
            <button hx-get="{{ route('products.create') }}" 
    ...
    <div id="products-list" class="glass-card rounded-md overflow-hidden border border-gray-200 dark:border-gray-800">
        @include('products.products-list', ['products' => $products])
    </div>
</x-layouts.app>
