...
function buildWaConfirmUrl() {
    ...
    const text = `Halo Admin, saya ingin konfirmasi pembayaran untuk pesanan saya:\n\n*Nomor Pesanan:* ${props.order.order_number}\n*Atas Nama:* ${props.order.customer_name}\n*Total:* ${formatPrice(props.order.total)}\n\nMohon info untuk proses selanjutnya. Terima kasih!`;
        ...
        <div class="min-h-screen bg-gray-50 dark:bg-gray-950 pt-28 md:pt-36 pb-16 px-4">
            <div class="mx-auto max-w-4xl space-y-6">
                ...
                <section class="grid gap-6 md:grid-cols-12">
                    ...
                    <div class="md:col-span-7 xl:col-span-8 rounded-3xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-5 md:p-8 shadow-sm space-y-6">
                        ...
                        <div class="divide-y divide-gray-150 dark:divide-gray-800">
                            ...
                            >
                                <div class="relative w-11 h-11 sm:w-12 sm:h-12 rounded-xl bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 flex items-center justify-center overflow-hidden flex-shrink-0">
                                    ...
                                    <svg v-else class="w-5 h-5 text-gray-300 dark:text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                                </div>
                        ...
                        <div class="border-t border-gray-150 dark:border-gray-800 pt-5 space-y-3.5 text-sm">
                            ...
                            <div class="flex justify-between">
                                ...
                                <span class="font-bold text-gray-950 dark:text-white">{{ order.shipping_cost > 0 ? formatPrice(order.shipping_cost) : 'Dihitung Terpisah' }}</span>
                            </div>
                            <div v-if="order.shipping_cost > 0 && order.payment_method !== 'cod' && order.payment_status === 'unpaid'" class="text-[10px] text-amber-700 dark:text-amber-500 bg-amber-50 dark:bg-amber-950/30 p-2 rounded-lg leading-relaxed border border-amber-200 dark:border-amber-900/50 mt-1">
                                <span class="font-bold">*Perhatian:</span> Tarif ongkos kirim mungkin berubah (misal karena penyesuaian berat/volume ekspedisi). Sangat disarankan menekan tombol <strong>"Konfirmasi Pembayaran via WhatsApp"</strong> di bawah untuk memastikan total tagihan final dengan Admin sebelum mentransfer.
                            </div>
                            ...
                            <a
                                ...
                                class="mt-6 flex items-center justify-center gap-2 rounded-2xl bg-[#25D366] hover:bg-[#20ba5a] px-4 py-3.5 text-sm font-black text-white shadow-md transition active:scale-[0.98]"
                            >
                    ...
                    <div class="md:col-span-5 xl:col-span-4 rounded-3xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-6 md:p-8 shadow-sm space-y-6">
                        ...
                        <dl class="space-y-4 text-sm">
                            ...
                            <div v-if="order.customer_address">
                                ...
                                <dd class="mt-1 leading-relaxed text-gray-700 dark:text-gray-300 text-xs font-medium">
                                    {{ order.customer_address }}
                                    <template v-if="order.city || order.province">
                                        <br>
                                        <span class="text-gray-500 dark:text-gray-400">
                                            {{ order.city?.name }}, {{ order.province?.name }}
                                        </span>
                                    </template>
                                </dd>
                            </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-4">
                    <a
                        ...
                        class="inline-flex items-center justify-center gap-2 rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 px-4 py-3.5 text-sm font-black text-gray-700 dark:text-gray-300 shadow-sm transition hover:bg-gray-50 dark:hover:bg-gray-800 active:scale-[0.98]"
                    >
                    ...
                    <Link
                        ...
                        class="inline-flex items-center justify-center gap-2 rounded-2xl border border-amber-200 dark:border-amber-900/30 bg-amber-50/30 dark:bg-amber-950/10 px-4 py-3.5 text-sm font-black text-amber-700 dark:text-amber-400 shadow-sm transition hover:bg-amber-100/30 dark:hover:bg-amber-950/30 active:scale-[0.98]"
                    >
                        <svg class="h-4 w-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
